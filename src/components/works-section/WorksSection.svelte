<script>
    ...
    import WorksRevisual from './works/WorksRevisual.svelte';
...
<div class="container">
    ...
    <Scroller top="{0.2}" bottom="{0.8}" query={"div.work-container--redesign"} bind:index bind:offset bind:progress>
        ...
        <div slot="foreground">
            ...
            <WorksRevisual index={3} scrollInfo={{index, offset, progress}}/>
        </div>
    </Scroller>
...
<style>
    ...
    .container :global(.work-field:not(:first-of-type) .work-field-title) {
        margin-top: 2.6rem;
    }
